...
function guardarTranscript(transcript) {
  const archivo = 'transcript.txt';
  fs.appendFile(archivo, transcript + '\n', (err) => {
      if (err) {
          console.error('Error al guardar el transcript:', err);
      } else {
          console.log('Transcript guardado correctamente.');
      }
  });
}
